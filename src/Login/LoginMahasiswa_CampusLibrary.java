 ...
 * @author LENOVO
 */
public class LoginMahasiswa_CampusLibrary extends javax.swing.JFrame {
     ...
     */
    public LoginMahasiswa_CampusLibrary() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginMahasiswa_CampusLibrary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginMahasiswa_CampusLibrary().setVisible(true);
            }
        });
    }
